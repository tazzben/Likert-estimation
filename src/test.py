...
def testFunction():
    ...
    cj, beta, metrics = s.get_results(data, bootstrap_iterations=5234, alpha=0.05, columns=['feature1', 'feature2', 'feature3', 'feature4', 'block'], block_id='block', parametric_bootstrap=True, test_cj_difference=True)
    print("Cj DataFrame:")
    print(cj)
    print("\nBeta DataFrame:")
    print(beta)
